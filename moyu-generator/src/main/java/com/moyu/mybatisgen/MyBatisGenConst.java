...
public class MyBatisGenConst {
    ...
    // 包名
    public static final String MAIN_PACKAGE = "com.moyu.dal";
    public static final String DO_PACKAGE = "com.moyu.dal.model";
    public static final String QUERY_PACKAGE="com.moyu.dal.query";
    public static final String MAPPER_PACKAGE = "com.moyu.dal.mapper";
    public static final String MANAGER_PACKAGE= "com.moyu.manager";
    public static final String MANAGER_IMPL_PACKAGE= MANAGER_PACKAGE+".impl";

    public static final String MAPPER_EXT_PACKAGE = "com.moyu.dal.mapper.ext";
    ...
    // mapper xml 输出目录
    public static final String MAPPER_XML_DIR = WORK_DIR + "moyu-dao/src/main/resources/mapper/";
    // mapper-ext xml 输出目录
    public static final String MAPPER_EXT_XML_DIR = WORK_DIR + "moyu-dao/src/main/resources/mapper/ext/";
    // do/model 输出目录
    public static final String MAPPER_DO_DIR = WORK_DIR + "moyu-dao/src/main/java/com/moyu/dal/model";
    // query 输出目录
    public static final String MAPPER_QUERY_DIR = WORK_DIR + "moyu-dao/src/main/java/com/moyu/dal/query";
    // mapper java 输出目录
    ...
    public static final String MAPPER_EXT_JAVA_DIR = WORK_DIR + "moyu-dao/src/main/java/com/moyu/dal/mapper/ext";
    // java数据对象类模板
